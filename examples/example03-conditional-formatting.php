...
for($i=0; $i<1000; $i++)
{
    ...
    $sheet->writeRow(array($n1, $n2, $n3, $n4, $s1, $s2, $s3, $s4), array(['number_format' => 'GENERAL'],['number_format' => '$#,##0.00'],[],['number_format' => '#0.00%'],['font'=>'Arial','font-size'=>10,'font-style'=>'bold', 'fill'=>'#eee', 'halign'=>'center', 'border'=>'left,right,top,bottom'],[],[],[]) );
}
...
$sheet->setConditionalStyle('C1:C1001','$C1*10<5',array('border'=>'top,bottom', 'align' => 'center', 'number_format' => '#0.0%'));
